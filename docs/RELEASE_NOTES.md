...
Theme update (still 2.0.0): added persistent Light, Dark and System selectors across extension and website interfaces. Browser tests verify cross-page persistence, cross-window updates and live system-theme changes.
